...
public class PhotoViewDialog<T> {
  ...
  protected PhotoViewDialog(@NonNull Context context, @NonNull BuilderData<T> builderData) {
  ...
  /**
   * Builder class for {@link PhotoViewDialog}
   */
  public static class Builder<T> {
    ...
    /**
     * Creates a {@link PhotoViewDialog} with the arguments supplied to this builder. It does not
     * show the dialog. This allows the user to do any extra processing
     * before displaying the dialog. Use {@link #show()} if you don't have any other processing
     * to do and want this to be created and displayed.
     */
    public PhotoViewDialog<T> build() {
      return new PhotoViewDialog<>(context, data);
    }

    /**
     * Creates the {@link PhotoViewDialog} with the arguments supplied to this builder and
     * shows the dialog.
     */
    public PhotoViewDialog<T> show() {
      return show(true);
    }
     ...
     * @param animate whether the passed transition view should be animated on open. Useful for screen rotation handling.
     */
    public PhotoViewDialog<T> show(boolean animate) {
      PhotoViewDialog<T> viewer = build();
      viewer.show(animate);
      return viewer;
    }
  }
